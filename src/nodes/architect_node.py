...
def architect_node(state):
    ...
    print('='*20, 'Start architect_node')

    prd = JsonLoader.load(state["prd_path"])

    system = PromptLoader.load("agents/architect/system.md")
    rules = PromptLoader.load("agents/architect/rules.md")
...
"""
    ...
    state["architecture_path"] =  "outputs/architecture.json"
